...
class ApiService {
  static Future<String> sendMessage(String message) async {
    ...
    final responses = [
      ...
      "Đây là câu trả lời giả lập cho: \"$message\" aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa😄",
      ...
      "Hãy tưởng tượng đây là câu trả lời từ ChatGPT nhé 🧠"
    ];
