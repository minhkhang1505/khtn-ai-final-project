...
class BotFilterOptionMenu extends StatefulWidget {
  ...
  const BotFilterOptionMenu({super.key, required this.value, this.onChanged});
...
class _BotFilterOptionMenuState extends State<BotFilterOptionMenu> {
  ...
  @override
  void didUpdateWidget(covariant BotFilterOptionMenu oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (oldWidget.value != widget.value) selectedKey = widget.value;
  }
        ...
        (index) => PopupMenuItem<int>(
          ...
          child: Row(
            ...
            children: [
              ...
              if (selectedKey == options[index]['key'])
        ...
        child: Row(
          ...
          children: [
            ConstrainedBox(
              ...
              child: Text(
                options.firstWhere((o) => o['key'] == selectedKey, orElse: () => options[0])['label']!,
                style: TextStyle(
